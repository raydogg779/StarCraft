            ...
            if (location){
                ...
                this.moveTo(location.x,location.y,this.get('sight'),function(){
                    ...
                    bullet.fire(function(){
                        ...
                        var targets=Game.getInRangeOnes(location.x,location.y,[76*1.5,62*1.5],true,true);
                        //Slow moving speed
                        var bufferObj={
                    ...
                    var darkSwarm=function(){
                        ...
                        if (darkSwarms.length) {
                            ...
                            darkSwarms.forEach(function(swarm){
                                ...
                                targets=targets.concat(Game.getInRangeOnes(swarm.posX(),swarm.posY(),[126*1.5,94*1.5],false,true,false));
                            });
                            $.unique(targets);
                            //Effect
                            targets.forEach(function(chara){
        ...
        spell:function(location){
            ...
            if (location){
                ...
                this.moveTo(location.x,location.y,this.get('sight'),function(){
                    ...
                    if (anime.insideScreen()) new Audio('bgm/Magic.Ensnare.wav').play();
                    //Get in range enemy units
                    var targets=Game.getInRangeOnes(location.x,location.y,[64*1.5,64*1.5],true,true);
            ...
            if (location){
                ...
                this.moveTo(location.x,location.y,this.get('sight'),function(){
                    ...
                    bullet.fire(function(){
                        ...
                        var targets=Game.getInRangeOnes(location.x,location.y,[90*1.5,74*1.5],true);
                        //Effect
                        targets.forEach(function(chara){
                    ...
                    var stormWave=function(){
                        ...
                        if (psionicStorms.length) {
                            ...
                            psionicStorms.forEach(function(storm){
                                ...
                                targets=targets.concat(Game.getInRangeOnes(storm.posX(),storm.posY(),[94*1.5,76*1.5],null,true));
                            });
                            $.unique(targets);
                            //Effect
                            targets.forEach(function(chara){
            ...
            if (location){
                ...
                this.moveTo(location.x,location.y,this.get('sight'),function(){
                    ...
                    var anime=new Animation.MaelStormSpell({x:location.x,y:location.y,callback:function(){
                        ...
                        var targets=Game.getInRangeOnes(location.x,location.y,[64*1.5,64*1.5],true,true,null,function(chara){
        ...
        spell:function(location){
            ...
            if (location){
                ...
                var anime=new Animation.Recall({x:location.x,y:location.y,callback:function(){
                    ...
                    var targets=Game.getInRangeOnes(location.x,location.y,50*1.5,false,true);
            ...
            if (location){
                ...
                this.moveTo(location.x,location.y,this.get('sight'),function(){
                    ...
                    var anime=new Animation.StasisFieldSpell({x:location.x,y:location.y,callback:function(){
                        //Get in range units
                        var targets=Game.getInRangeOnes(location.x,location.y,64*1.5,null,true);
                    ...
                    var disruptionWeb=function(){
                        ...
                        if (disruptionWebs.length) {
                            ...
                            disruptionWebs.forEach(function(web){
                                ...
                                targets=targets.concat(Game.getInRangeOnes(web.posX(),web.posY(),[76*1.5,56*1.5],true,true,false));
                            });
                            $.unique(targets);
                            //Effect
                            targets.forEach(function(chara){
